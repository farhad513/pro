      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <motion.h2
            ...
            className="h2"
          >
            Crafting <span className="text-accent">digital experiences</span> that
            people love.
          </motion.h2>
          ...
          >
            ...
            modern, scalable, and high-performance web applications. From
            frontend UI to backend systems, I handle the complete development
            process to deliver powerful digital solutions.
          </motion.p>
